...
<Meta
    argTypes={{
        ...
        onSubmitValue: { action: 'onSubmitValue' },
    }}
...
Illustrator or XD. Note that to illustrate custom tab indeces, tabbing
through the inputs below should go from “Font size” to “Letter spacing”
