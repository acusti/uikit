...
`CSSValueInput` is a React component that renders a specialized text input for CSS values with intelligent unit handling, increment/decrement controls, validation, and normalization. Designed with the user experience of professional design tools like Adobe Illustrator, it automatically manages units, enforces constraints, and provides intuitive keyboard interactions.

## Key Features

- **Smart Unit Management** - Automatically applies appropriate units based on CSS value type
- **Arrow Key Increment/Decrement** - Use ↑/↓ keys to adjust values (Shift for 10x multiplier)
- **Automatic Validation** - Enforces min/max bounds and CSS value type constraints
- **Value Normalization** - Converts inputs to valid CSS values with proper units
- **Escape to Revert** - Press Escape to restore the last valid value
- **Custom Validators** - Support for regex or function-based validation of non-numeric values
- **Flexible Input Types** - Supports length, angle, time, percentage, and integer CSS values
- **Design Tool UX** - Text selection on focus, enter to confirm, intuitive interactions
...
function KeyframeEditor() {
    const [keyframes, setKeyframes] = useState([
        { offset: '0%', transform: 'translateX(0px) rotate(0deg)', opacity: '100%' },
        { offset: '50%', transform: 'translateX(100px) rotate(180deg)', opacity: '50%' },
        { offset: '100%', transform: 'translateX(0px) rotate(360deg)', opacity: '100%' }
    ]);
    ...
    const updateKeyframe = (index: number, property: string, value: string) => {
        ...
        <div className="keyframe-editor">
            ...
            <div className="animation-controls">
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setAnimationSettings(prev => ({ ...prev, duration: value }))}
                    min={0}
                    step={0.1}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setAnimationSettings(prev => ({ ...prev, delay: value }))}
                    min={0}
                    step={0.1}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setAnimationSettings(prev => ({ ...prev, iterations: value }))}
                    min={1}
                    validator={(value) => value === 'infinite' || !isNaN(Number(value))}
                />
            </div>
                ...
                <div key={index} className="keyframe">
                    ...
                    <div className="keyframe-controls">
                        <CSSValueInput
                            ...
                            onSubmitValue={(value) => updateKeyframe(index, 'offset', value)}
                            min={0}
                            max={100}
                            step={5}
                        />
                        ...
                        <CSSValueInput
                            ...
                            onSubmitValue={(value) => updateKeyframe(index, 'opacity', value)}
                            min={0}
                            max={100}
                            step={10}
                        />
        ...
        <div className="grid-builder">
            ...
            <div className="grid-controls">
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setGridSettings(prev => ({ ...prev, columnGap: value }))}
                    min={0}
                    step={4}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setGridSettings(prev => ({ ...prev, rowGap: value }))}
                    min={0}
                    step={4}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setGridSettings(prev => ({ ...prev, padding: value }))}
                    min={0}
                    step={4}
                />
            </div>
            ...
            <div className="item-controls">
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setItemSettings(prev => ({ ...prev, columnStart: value }))}
                    min={1}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setItemSettings(prev => ({ ...prev, columnEnd: value }))}
                    min={1}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setItemSettings(prev => ({ ...prev, rowStart: value }))}
                    min={1}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setItemSettings(prev => ({ ...prev, rowEnd: value }))}
                    min={1}
                />
            </div>
...
function CustomValidators() {
    ...
    const cssFunctionValidator = (value: string) => {
        return /^(calc|var|min|max|clamp)\(.*\)$/.test(value) || !isNaN(parseFloat(value));
    };
    ...
    const displayKeywordValidator = (value: string) => {
        const validKeywords = ['block', 'inline', 'flex', 'grid', 'none', 'inline-block'];
    ...
    return (
        <div>
            ...
            <CSSValueInput
                ...
                max={999}
                step={1}
                validator={(value) => value === 'auto' || !isNaN(parseInt(value))}
            />
        </div>
    );
}
...
- **Unit preservation** - Keeps the unit from the previous value when possible
...
const StyledBox = styled.div<{ width: string; height: string; rotation: string }>`
        ...
        <div>
            <div className="controls">
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setBoxStyles(prev => ({ ...prev, width: value }))}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setBoxStyles(prev => ({ ...prev, height: value }))}
                />
                ...
                <CSSValueInput
                    ...
                    onSubmitValue={(value) => setBoxStyles(prev => ({ ...prev, rotation: value }))}
                    step={15}
                />
            </div>
...
- **Label Association** - Proper label/input relationships for screen readers
...
See the [Storybook documentation and examples](https://uikit.acusti.ca/?path=/docs/uikit-controls-CSSValueInput--docs) for interactive demonstrations of all CSS value input features and configurations.
