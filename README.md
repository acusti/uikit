...
| **[@acusti/vite-plugin-react-compiler][]** | [![latest version](https://img.shields.io/npm/v/@acusti/vite-plugin-react-compiler?style=flat-square)](https://www.npmjs.com/package/@acusti/vite-plugin-react-compiler) | Vite plugin that runs React Compiler natively via oxc-transform-react (no Babel)                         |
